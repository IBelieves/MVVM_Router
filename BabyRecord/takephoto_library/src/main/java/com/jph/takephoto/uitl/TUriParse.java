...
public class TUriParse {
    ...
    public static Uri getTempUri(Context context) {
        ...
        File file = new File(  Build.VERSION.SDK_INT >= 29?context.getExternalFilesDir(null) :Environment.getExternalStorageDirectory(), "/images/" + timeStamp + ".jpg");
...
//@TODO("安卓手机29版本及以上 创建路径要放在私有目录 ，查看时候可以直接uri查看，uri获取File需要如下面注视一样")
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    try {
                        ...
                        picturePath = cache.getAbsolutePath();
                        fos.close();
                        is.close();
                    } catch (IOException e) {
                        e.printStackTrace();
